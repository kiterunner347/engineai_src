...
#include "interface_protocol/msg/detail/motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _MotorState__ros_msg_type = interface_protocol__msg__MotorState;
...
size_t get_serialized_size_interface_protocol__msg__MotorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorState__ros_msg_type * ros_message = static_cast<const _MotorState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_protocol__msg__MotorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface_protocol
size_t max_serialized_size_interface_protocol__msg__MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_protocol__msg__MotorState;
    is_plain =
      (
...
static size_t _MotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_protocol__msg__MotorState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_protocol, msg, MotorState)() {
