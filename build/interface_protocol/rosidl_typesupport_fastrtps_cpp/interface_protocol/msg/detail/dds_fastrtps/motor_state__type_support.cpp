...
#include "interface_protocol/msg/detail/motor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_protocol::msg::MotorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_protocol::msg::MotorState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_protocol::msg::MotorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_protocol::msg::MotorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_protocol::msg::MotorState *>(
    untyped_ros_message);
...
get_message_type_support_handle<interface_protocol::msg::MotorState>()
{
  return &interface_protocol::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_protocol, msg, MotorState)() {
  return &interface_protocol::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
