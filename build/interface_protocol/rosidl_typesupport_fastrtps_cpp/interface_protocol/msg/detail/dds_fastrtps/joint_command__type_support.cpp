...
#include "interface_protocol/msg/detail/joint_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_protocol::msg::JointCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_protocol::msg::JointCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: feed_forward_torque
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.feed_forward_torque[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: torque
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_protocol::msg::JointCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_protocol::msg::JointCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_protocol::msg::JointCommand *>(
    untyped_ros_message);
...
{
  return &interface_protocol::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_protocol, msg, JointCommand)() {
  return &interface_protocol::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
