...
#include "interface_protocol/msg/detail/body_vel_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_protocol::msg::BodyVelCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_protocol::msg::BodyVelCmd & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface_protocol
max_serialized_size_BodyVelCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_protocol::msg::BodyVelCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_protocol::msg::BodyVelCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_protocol::msg::BodyVelCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BodyVelCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interface_protocol::msg::BodyVelCmd *>(
...
static size_t _BodyVelCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BodyVelCmd(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BodyVelCmd__callbacks = {
...
static rosidl_message_type_support_t _BodyVelCmd__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BodyVelCmd__callbacks,
...
{
  return &interface_protocol::msg::typesupport_fastrtps_cpp::_BodyVelCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_protocol, msg, BodyVelCmd)() {
  return &interface_protocol::msg::typesupport_fastrtps_cpp::_BodyVelCmd__handle;
}
